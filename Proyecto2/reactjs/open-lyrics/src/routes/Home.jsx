...
const Home = () => {
  ...
  const [valuesSongs, setValuesSongs] = useState([minSongs, maxSongs]);
  ...
  //     .then((response) => response.json())
  //     .then((data) => setLanguagesFacet(data))
  //     .catch((error) => console.log("Error getting the data:", error));
  // }, []);

  // console.log("Breweries:", languagesFacet);
  console.log(results);
  return (
    // main container
